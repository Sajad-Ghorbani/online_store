...
class BestRestaurantWidget extends GetView<BestRestaurantsController> {
  const BestRestaurantWidget({Key? key}) : super(key: key);
          ...
          child: Obx(
            () => ListView.builder(
              ...
              itemBuilder: (context, index) {
                Restaurant restaurant = controller.bestList[index];
                return Container(
                  margin: EdgeInsets.only(
                    right:
                        controller.bestList.first.id == restaurant.id ? 0 : 5,
                    left: controller.bestList.last.id == restaurant.id ? 0 : 5,
                  ),
                  child: InkWell(
